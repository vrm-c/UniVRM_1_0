        ...
        protected IEnumerator BlinkRoutine()
        {
            while (true)
            {
                ...
                while (true)
                {
                    ...
                    BlendShapes.SetValue(VrmLib.BlendShapePreset.Blink, value);
                    yield return null;
                }
                BlendShapes.SetValue(VrmLib.BlendShapePreset.Blink, 1.0f);
                ...
                BlendShapes.SetValue(VrmLib.BlendShapePreset.Blink, 0);
            }
        }

        private void Awake()
        {
            if (BlendShapes == null) BlendShapes = GetComponent<UniVRM10.VRMBlendShapeProxy>();
        }
