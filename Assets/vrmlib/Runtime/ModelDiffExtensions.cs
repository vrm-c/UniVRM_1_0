...
namespace VrmLib.Diff
{
    public static class ModelDiffExtensions
    {
        ...
        static void Vrm(ModelDiffContext context, Model lhs, Model rhs)
        {
            ...
            ListDiff(context.Enter(nameof(lhs.Vrm.BlendShape)), lhs.Vrm.BlendShape.BlendShapeList, rhs.Vrm.BlendShape.BlendShapeList, VrmBlendShapeEquals, x => (int)x.Preset);
        ...
        static bool VrmBlendShapeEquals(ModelDiffContext context, BlendShape lhs, BlendShape rhs)
        {
            ...
            if (!ListDiff(context.Enter(nameof(lhs.BlendShapeValues)), lhs.BlendShapeValues, rhs.BlendShapeValues, VrmBlendShapeBindValueEquals)) equals = false;
            if (!ListDiff(context.Enter(nameof(lhs.MaterialValues)), lhs.MaterialValues, rhs.MaterialValues, VrmMaterialBindValueEquals)) equals = false;
            return equals;
        }
